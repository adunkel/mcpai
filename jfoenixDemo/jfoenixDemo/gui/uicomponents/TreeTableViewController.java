...
public class TreeTableViewController {
	...
	@FXML JFXTreeTableColumn<Person, String> firstNameColumn;
	@FXML JFXTreeTableColumn<Person, String> lastNameColumn;
	@FXML JFXTreeTableColumn<Person, Integer> ageColumn;
	@FXML JFXTreeTableColumn<Person, String> firstNameEditableColumn;
